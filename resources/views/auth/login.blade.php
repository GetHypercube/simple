                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="claveunica"
                                       class="col-lg-4 col-form-label text-lg-right">Ingresar con:</label>
                                <a href="{{route('login.claveunica')}}" class="col-lg-6" id="claveunica">
                                    <img class="" src="{{asset('img/btn_claveunica_172px.png')}}" alt="btn clave unica">
                                </a>
                            </div>
                            <hr>
