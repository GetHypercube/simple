                ...
                <div class="row align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-12">
                        <table class="table">
                            ...
                            <th>
                                E-Mail
                                <a href="{{ route('backend.configuration.backend_users').'?order_by_email='.(null==$order_by_email ? 'asc':$order_by_email) }}" class="arrow-order">
                            ...
                            <th>
                                Nombre
                                <a href="{{ route('backend.configuration.backend_users').'?order_by_name='.(null==$order_by_name ? 'asc':$order_by_name) }}" class="arrow-order">
                            ...
                            <th>
                                Apellidos
                                <a href="{{ route('backend.configuration.backend_users').'?order_by_lastname='.(null==$order_by_lastname ? 'asc':$order_by_lastname)  }}" class="arrow-order">
                            ...
                            <th>
                                Rol
                                <a href="{{ route('backend.configuration.backend_users').'?order_by_rol='.(null==$order_by_rol ? 'asc':$order_by_rol)  }}" class="arrow-order">
