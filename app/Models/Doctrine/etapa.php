    ...
    public function asignar($usuario_id)
    {
        ...
        if ($this->Tarea->asignacion_notificar) {
            ...
            if ($usuario->email) {
                ...
                $name_cuenta = $this->Tramite->Proceso->Cuenta->nombre_largo;
                $proceso = $this->Tramite->Proceso->nombre;
                $name_user = $usuario->nombres;
               // $message = '<p>' . $this->Tramite->Proceso->nombre . '</p><p>Se le ha asignado la tarea: ' . $this->Tarea->nombre . '</p><p>' . $url . '</p>';
                $message = '<div class="container-fluid"  id="container" > 
                <div class="row">
                    <div class="col">
                      ...
                      <text x=20 y=90 stroke="#373737" font-family="Roboto Slab" font-size="25px" > Se te Asignó una Tarea</text>
                      <text x=20 y=140 font-family="Roboto, Sans Serif" font-size="16px">Hola, se te ha asignado la tarea llamada: '.$this->Tarea->nombre.' en SIMPLE.</text>
                      <text x=20 y=160 font-family="Roboto, Sans Serif" font-size="16px">Correspondiente al proceso:</text>
                      <text x=20 y=180 font-family="Roboto, Sans Serif" font-size="16px">'.$proceso.'</text>
                      <text x=20 y=220 font-family="Roboto, Sans Serif" font-size="16px">Para poder llevar a cabo la tarea asignada, haz click en el siguiente link: </text>
                      <text x=20 y=250 href="'.$varurl.'" font-family="Roboto Slab" font-size="16px"><a font-family="Roboto, Sans Serif" font-size="16px" fill="#0F69B4" href="'. $varurl .'">'.$varurl.'</a></text>
                      <text x=20 y=300 font-family="Roboto, Sans Serif" font-size="16px">Saludos,</text>
                      <text x=20 y=320 font-family="Roboto, Sans Serif" font-size="16px" font-weight="bold">'.$name_cuenta.'</text>
                           </svg>
                       </div>
                     </div>
                   </div>
        ...
        if ($this->Tarea->asignacion_notificar) {
            ...
            foreach ($usuarios as $usuario) {
                if ($usuario->email) {
                    ...
                    $url = ' Podrá realizarla en: ' . $varurl . ' ';
                    $url = str_replace("..", ".", $url);
                    $nombre_cuenta = $this->Tramite->Proceso->Cuenta->nombre_largo;
                    $subject = 'Plataforma SIMPLE Informa: ¡Tiene una tarea pendiente! ';
                    $nombre_proceso = $this->Tramite->Proceso->nombre;
                   ...
                   <div class="row">
                       <div class="col">
                         ...
                         <text x=20 y=90 stroke="#373737" font-family="Roboto Slab" font-size="25px" > ¡Tiene una tarea pendiente!</text>
                         <text x=20 y=140 font-family="Roboto, Sans Serif" font-size="16px">Hola, la tarea de nombre: '.$this->Tarea->nombre.' ,correspondiente al proceso:</text>
                         <text x=20 y=160 font-family="Roboto, Sans Serif" font-size="16px">'.$nombre_proceso.' , figura como pendiente.</text>
                         <text x=20 y=200 font-family="Roboto, Sans Serif" font-size="16px">Para poder retomar la tarea, haz click en el siguiente link:</text>
                         <text x=20 y=220 href="'.$varurl.'" font-family="Roboto Slab" font-size="16px"><a font-family="Roboto, Sans Serif" font-size="16px" fill="#0F69B4" href="'. $varurl .'">'.$varurl.'</a></text>
                         <text x=20 y=270 font-family="Roboto, Sans Serif" font-size="16px">Saludos,</text>
                         <text x=20 y=290 font-family="Roboto, Sans Serif" font-size="16px" font-weight="bold">'.$nombre_cuenta.'</text>
                              </svg>
                          </div>
                        </div>
                      </div>
